    ...
    <section className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#714B67] to-[#8A6883]">
        ...
        >
          {/* Testimonial Cards */}
          <div className="relative bg-gradient-to-br rounded-xl from-purple-50 to-white h-[500px] sm:h-[400px] overflow-hidden">
          ...
          <div className="flex justify-center mt-6 gap-2">
            {testimonials.map((_, index) => (
              <motion.button
                ...
                className={`w-3 h-3 rounded-full cursor-pointer ${index === currentIndex ? 'bg-[#714B67]' : 'bg-gray-300'}`}
              />
            ))}
          </div>
        </motion.div>
