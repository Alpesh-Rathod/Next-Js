...
const Navbar = () => {
  ...
  return (
    <>
      <div aria-hidden={true} onClick={closeNavbar} className={`fixed bg-gray-800/40 inset-0 z-30 ${navIsOpened ? "lg:hidden" : "hidden lg:hidden"}`}></div>
      <header className="sticky top-0 w-full flex items-center h-20 shadow-md z-40 bg-white">
